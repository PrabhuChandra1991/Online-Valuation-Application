...
export class EvaluationListComponent implements OnInit {
  answerSheetList: any[] = [];
  displayedColumns: string[] = ['institutionName', 'courseCode', 'courseName', 'degreeTypeName', 'regulationYear', 'batchYear', 'examYear', 'examMonth', 'semester', 'examType', 'totalObtainedMark', 'actions'];
